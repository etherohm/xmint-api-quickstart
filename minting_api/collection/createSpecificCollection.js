...
async function createSpecificCollection(data){
    ...
    let mint_result;
    await fetch(process.env.API_ENDPOINT + `/${data.collection_name}`, requestOptions)
...
module.exports = { createSpecificCollection }
